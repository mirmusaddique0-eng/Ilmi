...
function Projects() {
  ...
  const loadPhaseContent = async (
    ...
    const {
      ...
      .from("build_project_phase_content")
      .select("*")
    ...
    console.log(
      "Project Phase Content from Supabase:",
      data
    );
